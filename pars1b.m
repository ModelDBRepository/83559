%%%% BASIC PARAMETERS SCRIPT - Mark Humphries 5/1/2005
...
if do_urethane
    spon(STN) = 5e-10; %11.0e-10 for awake and 7e-10 for urethane (6.25? - KG?)
else
    spon(STN) = 9e-10;
end

spon(GPe) = 3e-10;   %4e-10         
%spon(GPe) = randn(length(GPe),1)*(2e-11) + (4e-10);
%spon(GPi) = randn(length(GPi),1)*(2.5e-11) + (2.5e-10);          
spon(GPi) = 3.4e-10; %3.6e-10
