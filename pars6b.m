%%%% BASIC PARAMETERS SCRIPT - Mark Humphries 6/1/2006

%%% FOR Gamma-band with D2 agonist
...
%%%% dopamine
dop1 = 0.3;
dop2 = 1;   % tonic dopamine level (in [0 1] range) (0.3)
