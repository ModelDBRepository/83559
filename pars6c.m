%%%% BASIC PARAMETERS SCRIPT - Mark Humphries 11/5/2006

%%% For Gamma-band oscs with NMDA blocker in GP: note this simulation
%%% requires BATCH_BG_heterogenous_AMPA_NMDA2.m and
%%% BG_net_shunt_AMPA_NMDA2.m to handle the different AMPA and NMDA
%%% weights...
...
%%%%%%%%%%% DO NMDA WEIGHTS  %%%%%%%%%%%%%%%%%
STN_GPewNMDA = 0;           % remove NMDA from GP
STN_GPiwNMDA = STN_GPiw;
EXT_wNMDA = EXT_w;
STN_ext_ratio_NMDA = STN_ext_ratio;
