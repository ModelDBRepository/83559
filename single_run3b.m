function single_run3b()

% run selection and switching batch - low dopamine
...
pathroot = ['/home/mark/SpikingModel/ResultsArchive/Selection/HighDA/'];  % path to save files
pars_file = 'pars3b';
flags_file = 'sum_flags';

exp_name = 'selection_highDA';
type = 'sel';
