function single_run5_4a()
% run a single model and postprocess it
% LFO conditions A - without collaterals
...
pathroot = ['/home/mark/SpikingModel/ResultsArchive/LFO-urethane/NoCollaterals/ConditionA/'];  % path to save files
pars_file = 'pars5_4a';
