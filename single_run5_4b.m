function single_run5_4b()
% run a single model and postprocess it
% Condition B of LF study - without collaterals
...
pathroot = ['/home/mark/SpikingModel/ResultsArchive/LFO-urethane/NoCollaterals/ConditionB/'];  % path to save files
pars_file = 'pars5_4b';
