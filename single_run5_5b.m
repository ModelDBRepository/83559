function single_run5_5b()

% run a single model and postprocess it
% Condition B of LF study - without urethane
...
pathroot = ['/home/mark/SpikingModel/ResultsArchive/LFO-urethane/NoUrethane/ConditionB/'];  % path to save files
pars_file = 'pars5_5b';
