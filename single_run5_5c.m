function single_run5_5c()

% run a single model and postprocess it
% LFO condition C, without urethane
...
n_models = 6; % 6
structures = {'STN' 'GPe'};
n_cells_per_structure = [6 5];
extract_thresh = 0;

pathroot = ['/home/mark/SpikingModel/ResultsArchive/LFO-urethane/NoUrethane/ConditionC/'];  % path to save files
pars_file = 'pars5_5c';
