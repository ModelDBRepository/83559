function single_run5_5d()
% run a single model and postprocess it
% LFO condition D, without urethane
...
pathroot = ['/home/mark/SpikingModel/ResultsArchive/LFO-urethane/NoUrethane/ConditionD/'];  % path to save files
pars_file = 'pars5_5d';
